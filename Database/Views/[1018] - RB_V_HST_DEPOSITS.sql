...
CAST(REPLACE(DATA01."UMD_4", ',', '') AS NUMBER(23,3)) AS "UMD_4",
CAST(REPLACE(DATA01."UMD_5", ',', '') AS NUMBER(23,3)) AS "UMD_5",
...
CAST(DATA02."BRANCH_NUMBER" AS VARCHAR2(10)) AS "BRANCH_NUMBER",
...
CAST(DATA02."X_1" AS VARCHAR2(255)) AS "X_1",
CAST(DATA02."X_2" AS VARCHAR2(255)) AS "X_2",
CAST(DATA02."X_3" AS VARCHAR2(255)) AS "X_3",
CAST(DATA02."X_4" AS VARCHAR2(255)) AS "X_4",
CAST(DATA02."X_5" AS VARCHAR2(255)) AS "X_5",
CAST(DATA02."X_6" AS VARCHAR2(255)) AS "X_6",
CAST(DATA02."X_7" AS VARCHAR2(255)) AS "X_7",
CAST(DATA02."X_8" AS VARCHAR2(255)) AS "X_8",
CAST(DATA02."X_9" AS VARCHAR2(255)) AS "X_9",
CAST(DATA02."X_10" AS VARCHAR2(255)) AS "X_10",
CAST(DATA02."X_11" AS VARCHAR2(255)) AS "X_11",
CAST(DATA02."X_12" AS VARCHAR2(255)) AS "X_12",
CAST(DATA02."X_13" AS VARCHAR2(255)) AS "X_13",
CAST(DATA02."X_14" AS VARCHAR2(255)) AS "X_14",
CAST(DATA02."X_15" AS VARCHAR2(255)) AS "X_15",
CAST(DATA02."X_16" AS VARCHAR2(255)) AS "X_16",
CAST(DATA02."X_17" AS VARCHAR2(255)) AS "X_17",
CAST(DATA02."X_18" AS VARCHAR2(255)) AS "X_18",
CAST(DATA02."X_19" AS VARCHAR2(255)) AS "X_19",
CAST(DATA02."X_20" AS VARCHAR2(255)) AS "X_20",
CAST(DATA02."X_21" AS VARCHAR2(255)) AS "X_21",
CAST(DATA02."X_22" AS VARCHAR2(255)) AS "X_22",
CAST(DATA02."X_23" AS VARCHAR2(255)) AS "X_23",
CAST(DATA02."X_24" AS VARCHAR2(255)) AS "X_24",
CAST(DATA02."X_25" AS VARCHAR2(255)) AS "X_25",
CAST(DATA02."X_26" AS VARCHAR2(255)) AS "X_26",
CAST(DATA02."X_27" AS VARCHAR2(255)) AS "X_27",
CAST(DATA02."X_28" AS VARCHAR2(255)) AS "X_28",
CAST(DATA02."X_29" AS VARCHAR2(255)) AS "X_29",
CAST(DATA02."X_30" AS VARCHAR2(255)) AS "X_30",
CAST(DATA02."X_31" AS VARCHAR2(255)) AS "X_31",
CAST(DATA02."X_32" AS VARCHAR2(255)) AS "X_32",
CAST(DATA02."X_33" AS VARCHAR2(255)) AS "X_33",
CAST(DATA02."X_34" AS VARCHAR2(255)) AS "X_34",
CAST(DATA02."X_35" AS VARCHAR2(255)) AS "X_35",
CAST(DATA02."X_36" AS VARCHAR2(255)) AS "X_36",
CAST(DATA02."X_37" AS VARCHAR2(255)) AS "X_37",
CAST(DATA02."X_38" AS VARCHAR2(255)) AS "X_38",
CAST(DATA02."X_39" AS VARCHAR2(255)) AS "X_39",
CAST(DATA03."X_40" AS VARCHAR2(255)) AS "X_40",
CAST(DATA03."X_41" AS VARCHAR2(255)) AS "X_41",
CAST(DATA03."X_42" AS VARCHAR2(255)) AS "X_42",
CAST(DATA03."X_43" AS VARCHAR2(255)) AS "X_43",
CAST(DATA03."X_44" AS VARCHAR2(255)) AS "X_44",
CAST(DATA03."X_45" AS VARCHAR2(255)) AS "X_45",
CAST(DATA03."X_46" AS VARCHAR2(255)) AS "X_46",
CAST(DATA03."X_47" AS VARCHAR2(255)) AS "X_47",
CAST(DATA03."X_48" AS VARCHAR2(255)) AS "X_48",
CAST(DATA03."X_49" AS VARCHAR2(255)) AS "X_49",
CAST(DATA03."X_50" AS VARCHAR2(255)) AS "X_50",
CAST(DATA03."X_51" AS VARCHAR2(255)) AS "X_51",
CAST(DATA03."X_52" AS VARCHAR2(255)) AS "X_52",
CAST(DATA03."X_53" AS VARCHAR2(255)) AS "X_53",
CAST(DATA03."X_54" AS VARCHAR2(255)) AS "X_54",
CAST(DATA03."X_55" AS VARCHAR2(255)) AS "X_55",
CAST(DATA03."X_56" AS VARCHAR2(255)) AS "X_56",
CAST(DATA03."X_57" AS VARCHAR2(255)) AS "X_57",
CAST(DATA03."X_58" AS VARCHAR2(255)) AS "X_58",
CAST(DATA03."X_59" AS VARCHAR2(255)) AS "X_59",
CAST(DATA03."X_60" AS VARCHAR2(255)) AS "X_60",
CAST(DATA03."X_61" AS VARCHAR2(255)) AS "X_61",
CAST(DATA03."X_62" AS VARCHAR2(255)) AS "X_62",
CAST(DATA03."X_63" AS VARCHAR2(255)) AS "X_63",
CAST(DATA03."X_64" AS VARCHAR2(255)) AS "X_64",
CAST(DATA03."X_65" AS VARCHAR2(255)) AS "X_65",
CAST(DATA03."X_66" AS VARCHAR2(255)) AS "X_66",
CAST(DATA03."X_67" AS VARCHAR2(255)) AS "X_67",
CAST(DATA03."X_68" AS VARCHAR2(255)) AS "X_68",
CAST(DATA03."X_69" AS VARCHAR2(255)) AS "X_69",
CAST(DATA03."X_70" AS VARCHAR2(255)) AS "X_70",
CAST(DATA03."X_71" AS VARCHAR2(255)) AS "X_71",
CAST(DATA03."X_72" AS VARCHAR2(255)) AS "X_72",
CAST(DATA03."X_73" AS VARCHAR2(255)) AS "X_73",
CAST(DATA03."X_74" AS VARCHAR2(255)) AS "X_74",
CAST(DATA03."X_75" AS VARCHAR2(255)) AS "X_75",
DATA01."PROVENIENZA",
KEYS."USERUPD",
DATA01."DATEUPD"
FROM
...
RB_STG_DEPOSITS_03
  ...
  ON
KEYS.RB_ROWID = DATA03.RB_ROWID AND
KEYS.MONTH_END_DATE = DATA03.MONTH_END_DATE AND
KEYS.REPORTING_ENTITY = DATA03.REPORTING_ENTITY AND
KEYS.USERUPD = DATA03.USERUPD;