...
SELECT
	...
	CAST(UMD_1 AS VARCHAR2(255)) AS UMD_1,
	CAST(SOURCE AS VARCHAR2(4)) AS SOURCE,
	CAST(UMD_2 AS VARCHAR2(255)) AS UMD_2,
	CAST(UMD_3 AS VARCHAR2(255)) AS UMD_3,
	CAST(UMD_4 AS VARCHAR2(255)) AS UMD_4,
	...
	CAST(FILLER_2_ORIGINATION_DATE AS VARCHAR2(250)) AS FILLER_2_ORIGINATION_DATE,
	CAST(FILLER_3_ORIGINAL_MATURITY AS VARCHAR2(250)) AS FILLER_3_ORIGINAL_MATURITY,
	CAST(FILLER_4_CUSTOMER_NAME AS VARCHAR2(250)) AS FILLER_4_CUSTOMER_NAME,
	CAST(FILLER_5_SECURED_BORROWINGS AS VARCHAR2(250)) AS FILLER_5_SECURED_BORROWINGS,
	CAST(FILLER_6_IBF_ONLY_COLUMN_YN AS VARCHAR2(250)) AS FILLER_6_IBF_ONLY_COLUMN_YN,
	CAST(FILLER_7_RES_COUNTRY AS VARCHAR2(250)) AS FILLER_7_RES_COUNTRY,
	CAST(FILLER_8_RISK_COUNTRY AS VARCHAR2(250)) AS FILLER_8_RISK_COUNTRY,
