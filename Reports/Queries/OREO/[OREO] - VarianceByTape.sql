SELECT
	...
	CASE
		WHEN A.INSTRUMENT_ID IS NULL AND P.INSTRUMENT_ID_ID IS NOT NULL
	...
	CASE
	   ...
	   WHEN P.INSTRUMENT_ID IS NULL AND A.INSTRUMENT_ID IS NOT NULL
		  THEN CAST('NEW' AS VARCHAR(8))
		WHEN  A.INSTRUMENT_ID_ID <> P.INSTRUMENT_ID_ID
			  OR A.INSTRUMENT_ID_ID IS NULL AND P.INSTRUMENT_ID_ID IS NOT NULL
			  OR A.INSTRUMENT_ID_ID IS NOT NULL AND P.INSTRUMENT_ID_ID IS NULL
		  THEN CAST('VARIANCE' AS VARCHAR(8))
		ELSE CAST('OK' AS VARCHAR(8))
