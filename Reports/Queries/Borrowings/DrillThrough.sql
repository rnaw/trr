SELECT
    ...
    DATA.FILLER_1,
    DATA.FILLER_2_ORIGINATION_DATE,
    DATA.FILLER_3_ORIGINAL_MATURITY,
    DATA.FILLER_4_CUSTOMER_NAME,
    DATA.FILLER_5_SECURED_BORROWINGS,
    DATA.FILLER_6_IBF_ONLY_COLUMN_YN,
    DATA.FILLER_7_RES_COUNTRY,
    DATA.FILLER_8_RISK_COUNTRY,
    DATA.FILLER_9,
    DATA.FILLER_10,
    DATA.FILLER_11,
    DATA.FILLER_12,
